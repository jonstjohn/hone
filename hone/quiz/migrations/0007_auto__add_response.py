...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'quiz_response', (
            ...
            ('attempt', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['quiz.Attempt'])),
    ...
    models = {
        ...
        u'quiz.response': {
            ...
            'attempt': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['quiz.Attempt']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'quiz.topic': {
